...
class Cors implements TusMiddleware
{
    ...
    public function handle(Request $request, Response $response)
    {
        $response->setHeaders([
            ...
            'Access-Control-Allow-Headers' => 'Origin, X-Requested-With, Content-Type, Content-Length, Upload-Key, Upload-Checksum, Upload-Length, Upload-Offset, Tus-Version, Tus-Resumable, Upload-Metadata, x-http-method-override',
